...
<body>
    ...
    <button class="exit-button" onclick="exitSearch()" style="display: none;">X</button>
</div>
        </form>
    </div>
    <div id="result"></div>
         <a href="#contact" class="contact">Contact Us</a>
         <a href="adminlog.php" class="submits">Add Movie</a>
